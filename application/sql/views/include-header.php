<div class="navbar-bg"></div>
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block"><?= !empty($this->lang->line('label_hi'))?$this->lang->line('label_hi'):'Hi'; ?>, <?= $user->first_name ?></div></a>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <li <?= (current_url()== base_url('projects'))?'class="active"':''; ?> ><a class="nav-link" href="<?= base_url('projects'); ?>"><i class="fas fa-briefcase text-info"></i> <span> <?= !empty($this->lang->line('label_projects'))?$this->lang->line('label_projects'):'Projectss'; ?> </span></a></li>
