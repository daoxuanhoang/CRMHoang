<?php
$project_title = $invoice['project_title'] != '' ? 'for project -' . $invoice['project_title'] : '';
...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE, 'Invoice ' . $project_title);
