...
<head>
  ...
  <title>Expense Types &mdash; <?= get_compnay_title(); ?></title>
  <?php
...
<body>
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
          ...
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              <div class="btn-group mr-2 no-shadow">
                <a class="btn btn-primary text-white" href="<?= base_url('expenses') ?>" class="btn"><i class="fas fa-list"></i> <?= !empty($this->lang->line('label_expenses')) ? $this->lang->line('label_expenses') : 'Expenses'; ?></a>
              </div>
          ...
          <div class="section-body">
            <div class="row">
              <div class='col-md-12'>
                <div class="card">
                  <div class="card-body">
                    <table class='table-striped' id='expense_type_list' data-toggle="table" data-url="<?= base_url('expenses/get_expense_type_list') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel"]' data-export-options='{
      ...
      <?= form_open('expenses/edit_expense_type', 'id="modal-edit-expense-type-part"', 'class="modal-part"'); ?>
      <div class="row">
        <div class="col-md-6">
...
<script src="<?= base_url('assets/js/page/components-expense-types.js'); ?>"></script>
