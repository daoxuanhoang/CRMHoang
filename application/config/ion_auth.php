 ...
 */
$config['site_title']                 = !empty(get_compnay_title())?get_compnay_title():'CRMHoang';       // Site Title, example.com
$config['admin_email']                = !empty(get_admin_email())?get_admin_email():'info@example.com';  // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['client_group']               = 'clients';  
